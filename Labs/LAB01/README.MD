...
· Deploy Microsoft Sentinel as a platform for visualizing, investigating, and alerting on your customer's security big data
...
# Exercise 1: Review Microsoft Sentinel Data Connectors
In this exercise you will be reviewing the data connectors of Microsoft Sentinel to confirm that data is already being collected in the Sentinel Workspace.  Data connectors are critical to a setup of Microsoft Sentinel so that data can flow into the workspace.  To save time, these data connectors have been configured in advance.<br>
...
LAB 02 -Setup Alerts (Analytics) and Respond to Cases in Microsoft Sentinel, click <a href="../LAB02/README.MD" target="_blank">here</a>
